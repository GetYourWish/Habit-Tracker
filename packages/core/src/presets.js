...
//
// Each entry: { title, icon, frequencyKey, group }
...
const STARTER_HABITS = [
  // Body
  { title: 'Drink water', icon: '💧', frequencyKey: 'daily', group: 'Body' },
  { title: 'Move for 30 min', icon: '🏃', frequencyKey: 'daily', group: 'Body' },
  { title: 'Brush teeth', icon: '🪥', frequencyKey: 'weekdays', group: 'Body' },
  { title: 'Sleep before midnight', icon: '😴', frequencyKey: 'daily', group: 'Body' },
  ...
  // Mind
  { title: 'Read 20 minutes', icon: '📖', frequencyKey: 'daily', group: 'Mind' },
  { title: 'Journal', icon: '✍️', frequencyKey: 'weekdays', group: 'Mind' },
  { title: 'Meditate', icon: '🌬️', frequencyKey: 'daily', group: 'Mind' },
  ...
  { title: 'Digital detox evening', icon: '📵', frequencyKey: 'weekly', group: 'Mind' },
  // Home
  { title: 'Tidy 10 minutes', icon: '🧹', frequencyKey: 'daily', group: 'Home' },
  { title: 'Do the dishes', icon: '🍽️', frequencyKey: 'daily', group: 'Home' },
  ...
  // Work
  { title: 'Plan tomorrow', icon: '🗒️', frequencyKey: 'weekdays', group: 'Work' },
  { title: 'Inbox zero', icon: '📥', frequencyKey: 'weekdays', group: 'Work' },
  { title: 'Deep work block', icon: '🎯', frequencyKey: 'weekdays', group: 'Work' },
